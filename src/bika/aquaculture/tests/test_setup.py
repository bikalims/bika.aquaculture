...
from bika.aquaculture.testing import (
    BIKA_AQUACULTURE_INTEGRATION_TESTING,
)  # noqa: E501
...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("bika.aquaculture"))
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("bika.aquaculture"))
